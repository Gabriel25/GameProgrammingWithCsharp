...
namespace GameProject
{
    ...
    public class TeddyBear
    {
        ...
        {
            // move the teddy bear
            int distanceX = (int) (Velocity.X * gameTime.ElapsedGameTime.Milliseconds);
            int distanceY = (int) (Velocity.Y * gameTime.ElapsedGameTime.Milliseconds);
            drawRectangle.X += distanceX;
            drawRectangle.Y += distanceY;
            ...
            {
                Game1.AddProjectile(new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear),
                    drawRectangle.X+drawRectangle.Width/2, drawRectangle.Y +drawRectangle.Height/2 + GameConstants.TEDDY_BEAR_PROJECTILE_OFFSET, GetProjectileYVelocity()));
                shootSound.Play();
                elapsedShotTime = 0;
                firingDelay = GetRandomFiringDelay();
            }
